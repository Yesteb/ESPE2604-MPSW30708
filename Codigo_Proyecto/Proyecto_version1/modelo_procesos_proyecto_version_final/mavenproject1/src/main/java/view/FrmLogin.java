...
public class FrmLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnLogin.setBackground(EstiloUI.COLOR_PRIMARIO);
        btnLogin.setFont(new java.awt.Font("Tw Cen MT", 1, 18));
        btnLogin.setForeground(EstiloUI.COLOR_MUY_OSCURO);
        ...
        PnlExit.setBackground(EstiloUI.COLOR_PRIMARIO_CLARO);
        ...
        LblExit.setBackground(EstiloUI.COLOR_PRIMARIO_CLARO);
        ...
        jLabel1.setForeground(EstiloUI.COLOR_PRIMARIO);
    ...
    private void LblExitMouseEntered(java.awt.event.MouseEvent evt) {
        PnlExit.setBackground(EstiloUI.COLOR_SECUNDARIO_CLARO);
    }
    ...
    private void btnLoginMouseEntered(java.awt.event.MouseEvent evt) {
        btnLogin.setBackground(EstiloUI.COLOR_SECUNDARIO);
    }
    ...
    public static void main(String args[]) {
        ...
        // Antes de abrir el login hay que tener una base de datos alcanzable. Si
        // no la hay, DialogoConexion pide los datos en lugar de dejar que la
        // aplicación falle más tarde con una traza de Hibernate.
        if (!DialogoConexion.asegurarConexion()) {
            System.exit(0);
        }
