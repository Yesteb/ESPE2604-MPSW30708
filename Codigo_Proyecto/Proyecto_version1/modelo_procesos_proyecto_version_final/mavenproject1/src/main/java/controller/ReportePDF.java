...
public class ReportePDF {
    ...
    // ── Colores de la app (paleta de marca PinkyPuff) ───────────────────────────
    private static final Color ROSA         = EstiloUI.COLOR_PRIMARIO;
    private static final Color ROSA_CLARO   = EstiloUI.COLOR_PRIMARIO_CLARO;
    private static final Color GRIS_CLARO   = EstiloUI.COLOR_NEUTRO_CLARO;
    private static final Color GRIS_BORDE   = EstiloUI.COLOR_BORDE_NEUTRO;
    private static final Color TEXTO        = EstiloUI.COLOR_MUY_OSCURO;
    ...
    private static final Font F_STAT_ETIQUETA  = new Font(Font.HELVETICA,  8, Font.NORMAL, EstiloUI.COLOR_NEUTRO);
    ...
    private static final Font F_DATO_GRIS      = new Font(Font.HELVETICA,  8, Font.ITALIC, EstiloUI.COLOR_NEUTRO);
    private static final Font F_PIE            = new Font(Font.HELVETICA,  8, Font.NORMAL, EstiloUI.COLOR_NEUTRO);
    ...
    private static void celdaProducto(PdfPTable tabla, String texto, Color fondo) {
        ...
        c.setBackgroundColor(fondo);
        c.setPadding(4);
        c.setBorderColor(EstiloUI.COLOR_BORDE_NEUTRO);
        tabla.addCell(c);
    }
