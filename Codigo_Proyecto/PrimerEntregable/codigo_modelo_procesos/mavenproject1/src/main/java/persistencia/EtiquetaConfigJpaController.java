...
public class EtiquetaConfigJpaController implements Serializable, RepositorioEtiqueta {
    ...
    public void inicializarPorDefecto() {
        ...
        String[] estilos = {"Casual", "Formal", "Deportivo", "Bohemio", "Elegante", "Vintage", "Juvenil", "Básico"};
        ...
        for (int i = 0; i < estilos.length; i++)
            crear(new EtiquetaConfig("ESTILO", estilos[i], null, i));
        for (int i = 0; i < tallas.length; i++)
            crear(new EtiquetaConfig("TALLA", tallas[i], null, i));
